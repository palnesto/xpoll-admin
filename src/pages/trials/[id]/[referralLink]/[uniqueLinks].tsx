// src/pages/trials/[id]/[referralLink]/[uniqueLinks].tsx
...
const TrialUniqueVisitorsPage = () => {
  ...
  // ---- Build params: referralLinkIds is required ----
  const params = useMemo(() => {
    const p: Record<string, any> = {
      page,
      pageSize: PAGE_SIZE,
      referralLinkIds: linkId, // 👈 required
    };
    ...
    return p;
  }, [page, sortByVisits, sortDir, linkId]);
  ...
  const { data, isLoading, error, refetch } = useApiQuery(urlWithQuery, {
    key: ["referral-uniques-trial", trialId, linkId, urlWithQuery],
  } as any);
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Button
              ...
              onClick={() => navigate(`/trials/${trialId}/${referralLink}`)}
            >
...
export default TrialUniqueVisitorsPage;
