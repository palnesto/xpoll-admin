...
//                   onClick={() => navigate(`/trials/${id}/referrals`)}
//                 >
//                   Referral links
//                 </Button>
//                 {!isArchived && (
...
export default function TrialShowPage() {
  ...
  // ===== referral analytics for this trial entity =====
  ...
  const {
    ...
    key: ["entity-referral-analytics", "trial", id],
  } as any);
  ...
  const onSubmitEdit = handleSubmit(async (v) => {
    ...
    // targetGeo: ALWAYS send ID arrays
    const nextTG = v.targetGeo ?? { countries: [], states: [], cities: [] };
    const prevTG = {
      countries: Array.isArray(trial.targetGeo?.countries)
        ? trial.targetGeo!.countries
  ...
  return (
    <>
      ...
      >
            ...
            <section className="space-y-7">
              ...
              <FormCard title="Referral Analytics">
                ...
                {!isLoadingEntityAnalytics &&
                  ...
                  !entityAnalytics && (
                    <p className="text-xs text-muted-foreground">
                      No referral analytics found for this trial.
                    </p>
                  )}
        ...
        {/* Delete confirm inline (unused if you're using modal) */}
        {isDeleteOpen && (
          <div className="p-4 border rounded-md">
            <p className="mb-4 text-sm">
              Are you sure you want to delete this trial?
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={handleDelete} disabled={isDeletingMutating}>
                {isDeletingMutating ? "Deleting…" : "Delete"}
              </Button>
            </div>
          </div>
