...
const MemoPolls = () => {
  ...
  const handleResetAll = () => {
    ...
    reset();
    // Do NOT clear selections automatically – user may want to keep them
  };
  ...
  const bulkBar = anySelected ? (
    <div className="sticky top-[64px] z-30 bg-background/95 backdrop-blur border rounded-2xl px-3 py-2 flex flex-wrap gap-2 items-center justify-between">
